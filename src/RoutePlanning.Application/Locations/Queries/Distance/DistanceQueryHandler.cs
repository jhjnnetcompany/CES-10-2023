...
public sealed class DistanceQueryhandler : IQueryHandler<DistanceQuery, double>
{
    ...
    public async Task<double> Handle(DistanceQuery request, CancellationToken cancellationToken)
    {
        ...
        return distance.Sum(x => x.TimeInHours);
    }
}
